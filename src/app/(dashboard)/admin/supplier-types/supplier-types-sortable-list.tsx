...
import { reorderSupplierTypesAction, toggleSupplierTypeActiveAction } from './actions';
...
interface Props {
  rows: SupplierTypeRow[];
}

export function SupplierTypesSortableList({ rows }: Props) {
  const [items, setItems] = useState<SupplierTypeRow[]>(rows);
        ...
        >
          ...
          <td className="pr-5 text-right">
            <div className="inline-flex items-center gap-3">
              <Link
                href={`/admin/supplier-types/${t.id}/edit`}
