...
export default async function MarcheTypesPage() {
  let rows: any[] = [];
    ...
    <div className="space-y-8">
      ...
      <header className="page-header">
        ...
        <h1 className="mt-1.5 text-[32px] font-normal leading-tight text-zinc-900">
          <span className="display-serif">Types de marchés</span>
        ...
        <p className="mt-1.5 max-w-2xl text-[13px] text-zinc-500">
          Catalogue extensible des corps d'état (Démolition, Plomberie, Électricité, etc.) utilisés
          pour qualifier les sous-lots techniques d'un marché de travaux. Glisser-déposer pour
          réordonner.
        </p>
      </header>
      ...
      {!dbError && (
        <div className="card overflow-x-auto">
          <table className="table-base">
            ...
            <MarcheTypesSortableList rows={rows} />
          </table>
        </div>
      )}
