...
async function seedDocumentTypes(db: ReturnType<typeof drizzle<typeof schema>>) {
  const types: schema.NewDocumentType[] = [
    ...
    {
      code: 'compromis_achat',
      label: "Compromis d'achat",
      scope: 'property',
      sortOrder: 20,
      hasExpiration: false,
      category: 'notaire',
