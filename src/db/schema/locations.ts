...
import { locationTypeEnum, locationPeriodiciteEnum, documentCategoryEnum } from './enums';
...
export const locations = pgTable('locations', {
  ...
  chargesCourantes: numeric('charges_courantes', { precision: 14, scale: 2 }),
  fraisMenage: numeric('frais_menage', { precision: 14, scale: 2 }),
  taxeSejour: numeric('taxe_sejour', { precision: 14, scale: 2 }),
